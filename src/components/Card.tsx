...
const Card = ({ product }: CardProps) => {
  ...
  return (
    <Link
      href={`/products/${product.id}-${productSlug}`}
      className="group block overflow-hidden rounded-lg border border-gray-200 shadow-sm hover:shadow-lg transition-shadow duration-300"
    >
