    ...
    <div className="space-y-12">
      ...
      <div className="mt-8 text-center border-t-4 border-red-500 pt-8">
        ...
        <p className="text-gray-600 mt-2">
          Bu ek bölüm, &quot;admin&quot; rolüne sahip olduğunuz için
          gösterilmektedir.
        </p>
        <b>
          Veritabanı bağlantıları yapılan senaryoda Admin ürün ekleme-çıkartma
          işlemlerini bu panelden kontrol edebilir.{" "}
        </b>
      </div>
    </div>
  );
